...
let rec fact_tr_aux acc n =
  (fun fO fS n -> if n=0 then fO () else fS (n-1))
    (fun _ -> acc)
    (fun m -> fact_tr_aux (mul n acc) m)
    n

(** val fact : int -> int **)

let fact n =
  fact_tr_aux (Stdlib.Int.succ 0) n
    ...
    (fun fO fS n -> if n=0 then fO () else fS (n-1))
      ...
      (fun fO fS n -> if n=0 then fO () else fS (n-1))
        ...
        (fun fO fS n -> if n=0 then fO () else fS (n-1))
          ...
          (fun n3 ->
          (fun fO fS n -> if n=0 then fO () else fS (n-1))
            (fun _ -> Stdlib.Int.succ (Stdlib.Int.succ (Stdlib.Int.succ
            (Stdlib.Int.succ 0))))
            (fun n4 ->
            (fun fO fS n -> if n=0 then fO () else fS (n-1))
              (fun _ -> Stdlib.Int.succ (Stdlib.Int.succ (Stdlib.Int.succ
...
let latin_count_compute n =
  (fun fO fS n -> if n=0 then fO () else fS (n-1))
    (fun _ -> 0)
    (fun m -> mul (mul (fact n) (fact m)) (reduced_count n))
    n
        ...
        (fun fO fS n -> if n=0 then fO () else fS (n-1))
          ...
          (fun fO fS n -> if n=0 then fO () else fS (n-1))
            ...
            (fun fO fS n -> if n=0 then fO () else fS (n-1))
              ...
              mul
                (mul
                  (fact (Stdlib.Int.succ (Stdlib.Int.succ (Stdlib.Int.succ
...
let auto_upgrade_modes n diff =
  if eqb n (Stdlib.Int.succ (Stdlib.Int.succ (Stdlib.Int.succ 0)))
  then if ltb diff (Stdlib.Int.succ (Stdlib.Int.succ 0))
       then 0
       else if eqb diff (Stdlib.Int.succ (Stdlib.Int.succ 0))
            then mODE_KILLER
            else if eqb diff (Stdlib.Int.succ (Stdlib.Int.succ
                      (Stdlib.Int.succ 0)))
